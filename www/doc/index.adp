...
<p>
<a name="N10" id="N10"></a><strong>Installation</strong>
...
subsite-scoping features. If you geta "query returned no
rows" error, visit the admin/groups page for your subsite, so
that it can configure itself as necessary, and then try the
Directory package again.</p>
</div><div class="abstract">
<p>
<a name="N21" id="N21"></a><strong>Using the Directory
Package</strong>
...
"browse by letter" link will appear next to the search
box, to allow you to go back to browse mode. When searching or
browsing, the number of results per page can be restricted by
clicking one of the "show" links on the left side. You
also have the choice of viewing "subsite members" (people
who have been explicitly made a member of the current subsite) or
"all users" (all registered users of the site).</p>
</div>
</div>
